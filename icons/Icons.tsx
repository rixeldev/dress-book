...
export const RestartIcon = (props: any) => (
  <MaterialCommunityIcons name="restart" color={Theme.colors.text} size={24} {...props} />
)

export const UpdateIcon = (props: any) => (
  <MaterialCommunityIcons name="update" color={Theme.colors.text} size={24} {...props} />
)
...
export const CopyIcon = (props: any) => (
  <Ionicons name="copy-outline" color={Theme.colors.text} size={24} {...props} />
)
...
export const OfflineIcon = (props: any) => (
  <Octicons name="cloud-offline" color={Theme.colors.text} size={24} {...props} />
)
...
export const ComputerIcon = (props: any) => (
  <MaterialIcons name="computer" size={24} color={Theme.colors.text} {...props} />
)

export const VibrationIcon = (props: any) => (
  <MaterialIcons name="vibration" size={24} color={Theme.colors.text} {...props} />
)

export const PrivacyIcon = (props: any) => (
  <MaterialCommunityIcons name="security" size={24} color={Theme.colors.text} {...props} />
)

export const WebIcon = (props: any) => (
  <MaterialCommunityIcons name="web" size={24} color={Theme.colors.text} {...props} />
)
